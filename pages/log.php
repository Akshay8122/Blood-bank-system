...
<form action="c.php" method="POST" bgcolor="golden" class="sectiontitle center">
<fieldset>
 
<table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>


  <tr><td>BLOODBANK ID:</td><td><input type="email" name="mail" placeholder="Email" required><br></td></tr>
   
  
  <tr><td>PASSWORD:</td><td><input type="password" name="pwd" placeholder="Password" required></td><br></tr>
