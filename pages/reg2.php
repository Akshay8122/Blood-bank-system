...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h1><a href="index.html">Life@one touch</a></h1>
...
<div  bgcolor="white" class="sectiontitle center" >
      <h6 class="heading"><img src="donor.png"></h6>
      
    </div>
	
	
    
<form action="reg2.php" method="POST" bgcolor="golden" style="background-color:"grey" ">

   <table border='1' width='480px' cellpadding='0' cellspacing='0' align='center' >
<center><tr>
   <td><h1>Registration Form For Donor</h1></td>
</tr><center>
...
<tr>
    ...
    <td><input type='password' name='cpwd' placeholder="Password"  pattern="[a-zA-Z0-9]{2,10}" title="please enter only character or numbers between 12 to 18 for password" required></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
...
<tr>
    ...
    <td><select name="bg"><option>-Your bloodgroup-</option><option>A+</option><option>A-</option><option>B+</option><option>B-</option><option>AB+</option><option>AB-</option><option>O+</option><option>O-</option></select></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
    <td align='right'>State</td>
    <td><select name="bg"><option>-Your State-</option><option></option><option></option><option></option><option></option><option></option><option></option></select></td>
</tr>
<td>&nbsp;</td> </tr>
<tr>
    <td align='right'>upload pic:</td>
    <td><input type="file" name="file"></td>
</tr>
<tr>
    <td align='right'>Capcha:</td>
