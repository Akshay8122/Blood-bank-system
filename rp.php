...
<div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color: #FFFFFF; border:2px solid #FFFFFF; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">
 <table cellpadding="20" cellspacing="20" width="1000px" height="200px"  style="margin:auto" >

   <tr><td colspan="7" align="center"><h1>REQUEST FOR BLOOD</h1></td></tr>
